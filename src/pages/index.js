  ...
  render() {
    ...
    return (
      ...
      <div className="Hero HomeHero">
          <h1>Had a big Christmas?</h1>
          <h2>Bootcamp applications close at midnight 31st December.</h2>
          <br />
          <a href="/apply-for-bootcamp/" className="goldbutton">Book your place NOW</a>
      </div>
