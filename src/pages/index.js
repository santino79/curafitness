  ...
  render() {
    ...
    return (
      ...
      <div className="Hero HomeHero">
          <h1>Your Hard Work Pays Off.</h1>
          <h2>Our members are really feeling the benefits.</h2>
          <br />
          <a href="/success-stories/" className="goldbutton">Read Their Success Stories</a>
      </div>
